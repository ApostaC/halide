#ifndef HALIDE__bin______mat_mul_arm_h
#define HALIDE__bin______mat_mul_arm_h
#include <stdint.h>
...
int mat_mul(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_prod_global_wrapper_buffer) HALIDE_FUNCTION_ATTRS;
int mat_mul_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *mat_mul_metadata() HALIDE_FUNCTION_ATTRS;

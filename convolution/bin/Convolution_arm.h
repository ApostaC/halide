#ifndef HALIDE__bin______Convolution_arm_h
#define HALIDE__bin______Convolution_arm_h
#include <stdint.h>
...
int Convolution(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_buffer, int32_t _stride, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int Convolution_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *Convolution_metadata() HALIDE_FUNCTION_ATTRS;

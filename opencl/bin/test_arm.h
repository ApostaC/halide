#ifndef HALIDE__bin______test_arm_h
#define HALIDE__bin______test_arm_h
#include <stdint.h>
...
int Test(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_C_global_wrapper_buffer) HALIDE_FUNCTION_ATTRS;
int Test_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *Test_metadata() HALIDE_FUNCTION_ATTRS;

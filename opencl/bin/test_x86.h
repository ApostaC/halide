#ifndef HALIDE__bin______test_x86_h
#define HALIDE__bin______test_x86_h
#include <stdint.h>
...
int Test(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_C_buffer) HALIDE_FUNCTION_ATTRS;

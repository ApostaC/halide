#ifndef HALIDE_____resize_u8_h
#define HALIDE_____resize_u8_h
#include <stdint.h>
...
int resize_u8(struct halide_buffer_t *_input_buffer, float _scale_factor, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int resize_u8_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resize_u8_metadata() HALIDE_FUNCTION_ATTRS;

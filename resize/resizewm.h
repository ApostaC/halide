#ifndef HALIDE_____resizewm_h
#define HALIDE_____resizewm_h
#include <stdint.h>
...
int resizewm(struct halide_buffer_t *_input_buffer, int32_t _output_height, int32_t _output_width, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int resizewm_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resizewm_metadata() HALIDE_FUNCTION_ATTRS;
